    ...
    <>
      ...
      <div className="card-group row">
        ...
        <div className="card col-sm-4 h-50 d-inline-block">
          ...
          <div className="card-body">
            <h5 className="card-title">
              Porcenaje cumplimiento Eliminacion Cortopunzantes global por meses
            </h5>
            <p className="card-text">
        ...
        <div className="card col-sm-4 h-50 d-inline-block">
          ...
          <div className="card-body">
            <h5 className="card-title">
              porcentaje de cumplimiento de Almacenamiento de Material Esteril
              Global por meses
            </h5>
            <p className="card-text">
              This is a wider card with supporting text below as a natural
...
export default PerfilUsuarioPantalla2;
